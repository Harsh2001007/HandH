...
import "./App.css";
import { analytics } from "./firbase/firebaseInit";
import {
  getAuth,
...
function App() {
  ...
  return (
    <>
      <div className="main">
        <div
          className={`container a-container ${isTxl ? "is-txl" : ""}`}
          id="a-container"
        >
          <form className="form" id="a-form" method="" action="">
            ...
            />
            {errMsg ? (
              <h2 className="email_error">
                Email already in use or connection timeout.
              </h2>
            ) : (
              <></>
            )}
        ...
        <div
          className={`container b-container ${isTxl ? "is-txl" : ""} ${
            isZ200 ? "is-z200" : ""
          }`}
          id="b-container"
        >
          <form className="form" id="b-form" method="" action="">
            ...
            />
            {loginErr ? (
              <p className="failed_login_text">Invalid Credentials</p>
            ) : (
              <></>
            )}
        ...
        >
          ...
          ></div>
          <div
            className={`switch__container ${isHidden ? "" : "is-hidden"}`}
            id="switch-c1"
          >
